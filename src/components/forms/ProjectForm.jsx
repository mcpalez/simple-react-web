    ...
    return (
        <div className="project--form-container">
            <div className="project-form">
                ...
                <Row>
                    <Col className='project--form-col' md={6} xs={6}>
                        <Form.Group className="contact-field" controlId="formBasicEmail" hasValidation>
                            <Form.Label>First name *</Form.Label>
                            <Form.Control minlength="3" type="text" name='project_first_name' placeholder='e.g. Sophia' required/>
                        </Form.Group>
                    </Col>
                    <Col className='project--form-col'  md={6} xs={6}>
                        <Form.Group className="contact-field" controlId="formBasicEmail" hasValidation>
                            <Form.Label>Last name *</Form.Label>
                            <Form.Control minlength="3" type="text" name='project_last_name' placeholder='e.g. Millan' required/>
                        </Form.Group>
                    </Col>
                </Row>
                <Row>
                    <Col className='project--form-col' md={12}>
                        <Form.Group className="contact-field" controlId="formBasicEmail" hasValidation>
                            ...
                            <Form.Control minlength="3" type="email" name='project_email' placeholder='e.g. sophia@example.com' required/>
                        </Form.Group>
                    </Col>
                </Row>
                <Row>
            ...
            <div className="policy-note">
                <p>By clicking on “Send Inquiry” button, you agree to our <em className='underlined-text'>Privacy Policy</em>, 
